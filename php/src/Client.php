...
namespace APIVerve\Companylookup;
...
/**
 * Client for the Company Lookup API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/companylookup?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/companylookup';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CompanylookupClient] {$message}\n";
        }
    }
}
