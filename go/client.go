...
const (
	baseURL        = "https://api.apiverve.com/v1/companylookup"
	defaultTimeout = 30 * time.Second
)

// Client is the Company Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Company Lookup API client.
...
// Execute makes a request to the Company Lookup API with typed parameters.
//
