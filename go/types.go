// Package companylookup provides a Go client for the Company Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/companylookup?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Company Lookup API.
//
// Parameters:
//   - ticker (required): string - Stock ticker symbol (e.g. AAPL, MSFT, GOOGL) [minLength: 1, maxLength: 5]
type Request struct {
...
// ResponseData contains the data returned by the Company Lookup API.
type ResponseData struct {
	...
	Addresses AddressesData `json:"addresses"`
	FormerNames []interface{} `json:"formerNames"`
}

// AddressesData represents the addresses object.
type AddressesData struct {
	Mailing MailingData `json:"mailing"`
	Business BusinessData `json:"business"`
}

// MailingData represents the mailing object.
...
// BusinessData represents the business object.
