...
namespace APIVerve.API.CompanyLookup
{
    ...
    /// <summary>
    /// Client for the CompanyLookup API
    /// </summary>
    public class CompanyLookupAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/companylookup";
        ...
        public CompanyLookupAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CompanyLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CompanyLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CompanyLookupQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CompanyLookupQueryOptions options)
        {
        ...
        public ResponseObj Execute(CompanyLookupQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CompanyLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CompanyLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CompanyLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CompanyLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CompanyLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CompanyLookupQueryOptions options)
        {
