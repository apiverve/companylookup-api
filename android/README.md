...
```gradle
dependencies {
    implementation 'com.github.apiverve:companylookup-api:1.1.14'
}
```
...
```java
import com.apiverve.companylookup.CompanyLookupAPIClient;
import com.apiverve.companylookup.APIResponse;
import com.apiverve.companylookup.APIException;

// Initialize the client
CompanyLookupAPIClient client = new CompanyLookupAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/companylookup](https://docs.apiverve.com/ref/companylookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/companylookup](https://docs.apiverve.com/ref/companylookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/companylookup-api/issues)
