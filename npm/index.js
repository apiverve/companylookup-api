...
class companylookupWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/companylookup');
        }
        ...
        this.validationRules = {"ticker":{"type":"string","required":true,"minLength":1,"maxLength":5}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/companylookup`);
        }
    }
...
module.exports = companylookupWrapper;
